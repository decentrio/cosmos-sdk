...
$SIMD start --log_level=info --home ./testnet/node0/simdv2
$SIMD start --log_level=info --home ./testnet/node1/simdv2
$SIMD start --log_level=info --home ./testnet/node2/simdv2
