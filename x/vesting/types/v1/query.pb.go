...
func (m *QueryOwnerVestingAccountRequest) Reset()         { *m = QueryOwnerVestingAccountRequest{} }
func (m *QueryOwnerVestingAccountRequest) String() string { return proto.CompactTextString(m) }
func (*QueryOwnerVestingAccountRequest) ProtoMessage()    {}
func (*QueryOwnerVestingAccountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5f809c257a71960c, []int{18}
}
func (m *QueryOwnerVestingAccountRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryOwnerVestingAccountRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryOwnerVestingAccountRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryOwnerVestingAccountRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryOwnerVestingAccountRequest.Merge(m, src)
}
func (m *QueryOwnerVestingAccountRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryOwnerVestingAccountRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryOwnerVestingAccountRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryOwnerVestingAccountRequest proto.InternalMessageInfo

func (m *QueryOwnerVestingAccountRequest) GetOwner() string {
	if m != nil {
		return m.Owner
	}
	return ""
...
func (m *QueryOwnerVestingAccountRequest) GetVestingType() string {
	if m != nil {
...
func (m *QueryOwnerVestingAccountResponse) Reset()         { *m = QueryOwnerVestingAccountResponse{} }
func (m *QueryOwnerVestingAccountResponse) String() string { return proto.CompactTextString(m) }
func (*QueryOwnerVestingAccountResponse) ProtoMessage()    {}
func (*QueryOwnerVestingAccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5f809c257a71960c, []int{19}
}
func (m *QueryOwnerVestingAccountResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryOwnerVestingAccountResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryOwnerVestingAccountResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryOwnerVestingAccountResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryOwnerVestingAccountResponse.Merge(m, src)
}
func (m *QueryOwnerVestingAccountResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryOwnerVestingAccountResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryOwnerVestingAccountResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryOwnerVestingAccountResponse proto.InternalMessageInfo

func (m *QueryOwnerVestingAccountResponse) GetVestingAccounts() []string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*QueryOwnerVestingAccountRequest)(nil), "cosmos.accounts.vesting.v1.QueryOwnerVestingAccountRequest")
	proto.RegisterType((*QueryOwnerVestingAccountResponse)(nil), "cosmos.accounts.vesting.v1.QueryOwnerVestingAccountResponse")
}
...
var fileDescriptor_5f809c257a71960c = []byte{
	...
	,
}
...
func (m *QueryOwnerVestingAccountRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryOwnerVestingAccountRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryOwnerVestingAccountRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryOwnerVestingAccountResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryOwnerVestingAccountResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryOwnerVestingAccountResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.VestingAccounts) > 0 {
		for iNdEx := len(m.VestingAccounts) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.VestingAccounts[iNdEx])
			copy(dAtA[i:], m.VestingAccounts[iNdEx])
			i = encodeVarintQuery(dAtA, i, uint64(len(m.VestingAccounts[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *QueryOwnerVestingAccountRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryOwnerVestingAccountResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.VestingAccounts) > 0 {
		for _, s := range m.VestingAccounts {
			l = len(s)
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *QueryOwnerVestingAccountRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryOwnerVestingAccountRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryOwnerVestingAccountRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryOwnerVestingAccountResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryOwnerVestingAccountResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryOwnerVestingAccountResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.VestingAccounts = append(m.VestingAccounts, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
