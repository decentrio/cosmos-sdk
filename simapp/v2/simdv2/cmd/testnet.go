...
import (
	...
	simappv2 "cosmossdk.io/simapp/v2"
...
func startTestnet(cmd *cobra.Command, args startArgs) error {
	networkConfig := networkv2.DefaultConfig(simappv2.NewTestNetworkFixture)
	...
	networkLogger := networkv2.NewCLILogger(cmd)

	networkConfig.TxCodec = &temporaryTxDecoder[transaction.Tx]{networkConfig.TxConfig} //TODO
	...
	testnet, err := networkv2.New[serverv2.AppI[transaction.Tx], transaction.Tx](networkLogger, baseDir, networkConfig)
	if err != nil {
		return err
	}
